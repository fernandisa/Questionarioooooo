            ...
            <form action="upd-ok.jsp" method="post">
                ...
                <div class="mdl-cell--12-col">
                    <div class="mdl-select mdl-js-select mdl-select--floating-label">
                        <select class="mdl-select__input" id="selMonitor" name="selProfessor" value="<%=pa.getIdProfessor()%>">
                            <option value="">Selecione a resposta</option>
                            <%
                                String selected = "";
                                for (Professor item : lista) {
                                    if (item.getIdProfessor() == pa.getIdProfessor().getIdProfessor()) {
                                        selected = "selected";
                                    }
                            %>
                ...
                <div class="mdl-cell--12-col">
                    <div class="mdl-select mdl-js-select mdl-select--floating-label">
                        <select class="mdl-select__input" id="selQuestionario" name="selQuestionario" value="<%=pa.getIdQuestionario()%>">
                            <option value="">Selecione a resposta</option>
                            <%
                                String selecte = "";
                                for (Questionario item : qlista) {
                                    if (item.getIdQuestionario() == pa.getIdQuestionario().getIdQuestionario()) {
                                        selecte = "selecte";
                                    }
                            %>
